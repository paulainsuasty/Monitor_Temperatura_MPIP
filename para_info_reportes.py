...
print("Por favor digital el nombre del archivo del que desees recoger la información (no olvides el .csv al final!)")
nombre_archivo_revisar = input(">>> ")
a = open(nombre_archivo_revisar, "r")
lineas = a.readlines()
print(lineas)
...
print("el valor maximo encontrado fue: ")
